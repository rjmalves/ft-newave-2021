...
from idecomp.config import SUBSISTEMAS, REES  # type: ignore
...
class Caso:
    ...
    def constroi_caso_de_pasta(cls,
        ...
        gt_sin: List[float] = []
        earm_ree: Dict[str, List[float]] = {s: [] for s in REES}
        ...
        for a in relatos_pasta:
            ...
            if "INI" in a:
                ...
                for s in REES:
                    earms = re.energia_armazenada_inicial_ree[s]
                    earm_ree[s].append(earms)
            ...
            for s in SUBSISTEMAS:
                ...
                earm_subsis[s].append(earms)
            for s in REES:
                earms = re.energia_armazenada_ree[s][0]
                earm_ree[s].append(earms)
            # Calcula GT do SIN
