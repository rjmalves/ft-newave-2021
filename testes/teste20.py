...
# e verificar o atendimento às restrições de balanço hídrico
# e atendimento à demanda do problema resolvido pelo
# programa NEWDESP.
#
# - REE sem acoplamento hidráulico·
# - REE com acoplamento hidráulico·
...
#    python testes/teste22.py
#
# 6- Observar a saída exibida no terminal.

# OBSERVAÇÃO - TEMPORARIAMENTE RESOLVIDO POR PLANILHA
