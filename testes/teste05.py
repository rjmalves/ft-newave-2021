...
# TESTE 05
#
# Processar um caso com as funcionalidades PAR(p)-A e impressão
# dos arquivos de ENA habilitadas. Verificar os valores impressos
# nos arquivos energiaxf.csv, energiaxb.csv e energiaxs.csv.
# O caso deve usar reamostragem de cenários.
